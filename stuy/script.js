function getdate() {
    ...
    switch(day) {
        ...
        case 10:
            ...
            break;
        case 11:
            window.whichDay = "Veterans Day, No School";
            break;
        case 12:
            window.whichDay = 5;
            break;
        case 13:
            window.whichDay = "Half Day, Special Schedule";
            break;
        case 14:
            window.whichDay = 0;
            break;
        ...
        case 25:
            ...
            break;
        case 26:
            window.whichDay = "Thanksgiving, No School";
            break;
        case 27:
            window.whichDay = "Thanksgiving, No School";
            break;
...
function gettime() {
    ...
    if (window.whichDay == 0 || window.whichDay == 5) {
        if (day == 0 || day == 6) {
        ...
        document.getElementById("time").innerHTML = window.whichDay;
    }
